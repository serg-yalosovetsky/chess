...
def test_ruleset_all():
    moves_example = {1: {'from': V(7,0), 'to': []},
            2: {'from': V(7,1), 'to': [V(5,0), V(5,2)]},
            3: {'from': V(7,2), 'to': []},
            4: {'from': V(7,3), 'to': []},
            5: {'from': V(7,4), 'to': []},
            6: {'from': V(7,5), 'to': []},
            7: {'from': V(7,6), 'to': [V(5,5), V(5,7)]},
            8: {'from': V(7,7), 'to': []},
            9: {'from': V(6,0), 'to': [V(5,0), V(4,0)]},
            10: {'from': V(6,1), 'to': [V(5,1), V(4,1)]},
            11: {'from': V(6,2), 'to': [V(5,2), V(4,2)]},
            12: {'from': V(6,3), 'to': [V(5,3), V(4,3)]},
            13: {'from': V(6,4), 'to': [V(5,4), V(4,4)]},
            14: {'from': V(6,5), 'to': [V(5,5), V(4,5)]},
            15: {'from': V(6,6), 'to': [V(5,6), V(4,6)]},
            16: {'from': V(6,7), 'to': [V(5,7), V(4,7)]},
            17: {'from': V(1,0), 'to': [V(2,0), V(3,0)]},
            18: {'from': V(1,1), 'to': [V(2,1), V(3,1)]},
            19: {'from': V(1,2), 'to': [V(2,2), V(3,2)]},
            20: {'from': V(1,3), 'to': [V(2,3), V(3,3)]},
            21: {'from': V(1,4), 'to': [V(2,4), V(3,4)]},
            22: {'from': V(1,5), 'to': [V(2,5), V(3,5)]},
            23: {'from': V(1,6), 'to': [V(2,6), V(3,6)]},
            24: {'from': V(1,7), 'to': [V(2,7), V(3,7)]},
            25: {'from': V(0,0), 'to': []},
            26: {'from': V(0,1), 'to': [V(2,2), V(2,0)]},
            27: {'from': V(0,2), 'to': []},
            28: {'from': V(0,3), 'to': []},
            29: {'from': V(0,4), 'to': []},
            30: {'from': V(0,5), 'to': []},
            31: {'from': V(0,6), 'to': [V(2,7), V(2,5)]},
            32: {'from': V(0,7), 'to': []}}
